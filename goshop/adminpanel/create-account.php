...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $username_admin_seller = ($_POST['username_admin_seller']);
    $email_admin_seller = ($_POST['email_admin_seller']);
    $password = htmlspecialchars($_POST['password']);

    $hashedPassword = password_hash($password, PASSWORD_BCRYPT);

    $sql = "INSERT INTO admin_seller (username_admin_seller, email_admin_seller, password) VALUES ('$username_admin_seller', '$email_admin_seller', '$hashedPassword')";
    ...
    <div class="main d-flex flex-column justify-content-center align-items-center">
        <div class="login-box p-5 shadow">
            <form action="" method="post">
                ...
                <div>
                    <label for="username_admin_seller">Email</label>
                    <input type="text" class="form-control" name="email_admin_seller" id="username_admin_seller" autofocus autocomplete="off" required>
                </div>
                <div>
