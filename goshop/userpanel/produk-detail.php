        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 offset-md-1">
                    ...
                    <a href="beli.php?id=<?php echo $produk['id']; ?>" class="btn btn-primary"><i class="fa-solid fa-cart-plus"></i> Keranjang</a>
                    <a href="beli.php?id=<?php echo $produk['id']; ?>" class="btn btn-primary"><i class="fa-solid fa-money-bill-1-wave"></i> Beli</a>
                </div>
            </div>
        </div>
    </div>
